...
// =======================================================
// 3. إدارة العضوية (معدلة للتوافق مع الإدارة)
// =======================================================
...
// =======================================================
// 6. السلة والأوردر (معدلة للحماية والتزامن)
// =======================================================
...
// دالة إرسال الطلب (المحمية من التكرار)
async function submitOrderToServer(e) {
    e.preventDefault();
    if (isSubmitting) return; // منع اللمس الخاطئ
